          ...
          <div className="p-6 sm:p-8">
              ...
              <section>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between border-b border-gray-100 pb-2">
                    ...
                    <span className="text-gray-600 font-medium">Triassic</span>
                  </div>
                  <div className="flex justify-between border-b border-gray-100 pb-2">
            ...
            <div className="bg-emerald-50 rounded-lg p-4 border border-emerald-100">
              ...
              <p className="text-sm text-gray-700 mb-3">
                The Triassic period (252-201 million years ago) marked the dawn
                of the dinosaurs. These early dinosaurs were typically small and
                nimble compared to their later Jurassic and Cretaceous
                descendants.
              </p>
              <Link
                href="/triassic"
              ...
              >
                Explore more Triassic dinosaurs
                <svg
                  xmlns="http://www.w3.org/2000/svg"
