    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-950 text-slate-200">
        <div className="text-center">
          ...
          <p className="text-slate-400 text-sm">Digging up prehistoric data from the Triassic period</p>
        </div>
      </div>
    );
  }
    ...
    <main className="min-h-screen bg-slate-950 text-slate-200 sm:px-6 lg:px-8 pb-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 bg-slate-900/50 rounded-xl p-6 border border-slate-800 text-center md:text-left">
          <h3 className="text-lg font-bold text-white mb-2">About the Triassic Period</h3>
          <p className="text-slate-400 text-sm mb-4 leading-relaxed max-w-4xl">
            The Triassic is a geological period that lasted from about 252 to 201.3 million years ago. It is the first period of the Mesozoic Era. At around 50.8 million years, it is the seventh and one of the shorter geological periods of the entire Phanerozoic.
          </p>
          <button 
