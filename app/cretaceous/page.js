    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-stone-100 to-amber-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">Digging up prehistoric data from the Cretaceous period</p>
        </div>
      </div>
    );
  }
    ...
    <main className="min-h-screen bg-gradient-to-b from-stone-100 to-amber-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mb-12">
          ...
          <div className="text-center">
            <div className="inline-flex items-center justify-center bg-emerald-100 text-emerald-800 rounded-full px-6 py-2 mb-4">
              ...
              <span className="font-medium">145-66 Million Years Ago</span>
            </div>
        ...
        <div className="mt-16 bg-emerald-50 rounded-xl p-6 border border-emerald-100">
          <h3 className="text-xl font-bold text-emerald-900 mb-3">About the Cretaceous Period</h3>
          <p className="text-gray-700 mb-4">
            The Cretaceous is a geological period that lasted from about 143.1 to 66 million years ago. 
            It is the third and final period of the Mesozoic Era, as well as the longest. 
            At around 77.1 million years, it is the ninth and longest geological period of the entire Phanerozoic.
          </p>
          <button 
          ...
          >
            Learn more about the Cretaceous
